    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // Intent intent =new Intent(getApplicationContext(),PlayerView.class);
                //intent.putExtra("joke",tvTagline.getText().toString());
                Intent in =new Intent(Intent.ACTION_VIEW, Uri.parse("www.youtube.com/watch?v="+tvTagline.getText().toString()));
                startActivity(in);
            }
        });*/
        txt=(TextView)findViewById(R.id.ytb);
        txt.setText("www.youtube.com/watch?v="+tvTagline.getText().toString());
    }
